...
<head>        
        <title><?php echo $name; ?> &bull; Client Login</title>    
        <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
            ...
            <div class="page-content page-content-default">
                ...
                <div class="block-login">
                    <div class="block-login-logo">
                        <a class="logo">17559 Client Panel Registeration</a>
                    </div>                   
                    <div class="block-login-content">
                        <h1>Client Registeration</h1>
                        <form id="signinForm" method="POST" action="regprocess.php">
                        ...
                        <div class="form-group">                        
                              ...
                              <td><input name="user_name" type="text" id="user_name" class="required username" minlength="3" > </td>
                        </div>
                        <div class="form-group">                        
                        ...
                        <div class="form-group">
                            <td width="22%"><strong>Security Question: </strong><span class="required"><font color="#CC0000">*</font></span> </td>
                            <td width="78%">What Team brought you this site?<input name='confirm' id='confirm' class="required" type="text"> </td>
                        </div>


                        <button name = "login" class="btn btn-primary btn-block" type="submit">Register</button>                                        
