            ...
            <div class="page-content page-content-default">
                ...
                <div class="block-login">
                    <div class="block-login-logo">
                        <a class="logo">17559 Client Panel</a>
                    </div>     
                    <?php
                    if(isset($_POST['login']))
                    {
                        ...
                        $select_user = mysqli_query($con, "SELECT * FROM `admin` WHERE `id` = '$id'") or die(mysqli_error($con));
                        ...
                        {
                            $pass_check = mysqli_query($con, "SELECT * FROM `admin` WHERE `Username` = '$username' AND `id` = '$id'") or die(mysqli_error($con));
                            $row3 = mysqli_fetch_array($pass_check);

                            $select_pass = mysqli_query($con, "SELECT * FROM `admin` WHERE `Username` = '$username' AND `id` = '$id'") or die(mysqli_error($con));
								...
								else
                            {
                               ...
                               echo '<div class="alert alert-success">
                                    <button type="button" class="close" data-dismiss="alert" aria-hidden="true">X</button>
                                    <strong>Success Login!</strong> Redirecting..........
                                </div>
                                <br>';
